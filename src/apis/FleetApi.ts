...
import {
    ...
    ExtractResourcesWithSurveyRequestFromJSON,
    ExtractResourcesWithSurveyRequestToJSON,
...
export interface ExtractResourcesWithSurveyOperationRequest {
    shipSymbol: any;
    extractResourcesWithSurveyRequest?: ExtractResourcesWithSurveyRequest;
}
...
export class FleetApi extends runtime.BaseAPI {
     ...
     * Create Chart
     */
    async createChart(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateChart201Response> {
     ...
     * Scan Ships
     */
    async createShipShipScan(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateShipShipScan201Response> {
     ...
     * Scan Systems
     */
    async createShipSystemScan(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateShipSystemScan201Response> {
     ...
     * Scan Waypoints
     */
    async createShipWaypointScan(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateShipWaypointScan201Response> {
     ...
     * Create Survey
     */
    async createSurvey(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CreateSurvey201Response> {
     ...
     * Dock Ship
     */
    async dockShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<DockShip200Response> {
     ...
     * Extract Resources
     */
    async extractResources(shipSymbol: any, extractResourcesRequest?: ExtractResourcesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExtractResources201Response> {
     ...
     */
    async extractResourcesWithSurveyRaw(requestParameters: ExtractResourcesWithSurveyOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ExtractResources201Response>> {
        if (requestParameters.shipSymbol === null || requestParameters.shipSymbol === undefined) {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: ExtractResourcesWithSurveyRequestToJSON(requestParameters.extractResourcesWithSurveyRequest),
        }, initOverrides);
     ...
     * Extract Resources with Survey
     */
    async extractResourcesWithSurvey(shipSymbol: any, extractResourcesWithSurveyRequest?: ExtractResourcesWithSurveyRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ExtractResources201Response> {
        const response = await this.extractResourcesWithSurveyRaw({ shipSymbol: shipSymbol, extractResourcesWithSurveyRequest: extractResourcesWithSurveyRequest }, initOverrides);
        return await response.value();
    }
     ...
     * Get Mounts
     */
    async getMounts(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMounts200Response> {
     ...
     * Get Ship
     */
    async getMyShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMyShip200Response> {
     ...
     * Get Ship Cargo
     */
    async getMyShipCargo(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMyShipCargo200Response> {
     ...
     * List Ships
     */
    async getMyShips(page?: any, limit?: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetMyShips200Response> {
    ...
    async getRepairShipRaw(requestParameters: GetRepairShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetRepairShip200Response>> {
        if (requestParameters.shipSymbol === null || requestParameters.shipSymbol === undefined) {
            throw new runtime.RequiredError('shipSymbol','Required parameter requestParameters.shipSymbol was null or undefined when calling getRepairShip.');
        }
     ...
     * Get Repair Ship
     */
    async getRepairShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetRepairShip200Response> {
        const response = await this.getRepairShipRaw({ shipSymbol: shipSymbol }, initOverrides);
        return await response.value();
    }
    ...
    async getScrapShipRaw(requestParameters: GetScrapShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<GetScrapShip200Response>> {
        if (requestParameters.shipSymbol === null || requestParameters.shipSymbol === undefined) {
            throw new runtime.RequiredError('shipSymbol','Required parameter requestParameters.shipSymbol was null or undefined when calling getScrapShip.');
        }
     ...
     * Get Scrap Ship
     */
    async getScrapShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetScrapShip200Response> {
        const response = await this.getScrapShipRaw({ shipSymbol: shipSymbol }, initOverrides);
        return await response.value();
    }
     ...
     * Get Ship Cooldown
     */
    async getShipCooldown(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetShipCooldown200Response> {
     ...
     * Get Ship Nav
     */
    async getShipNav(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetShipNav200Response> {
     ...
     * Install Mount
     */
    async installMount(shipSymbol: any, installMountRequest?: InstallMountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<InstallMount201Response> {
     ...
     * Jettison Cargo
     */
    async jettison(shipSymbol: any, jettisonRequest?: JettisonRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Jettison200Response> {
     ...
     * Jump Ship
     */
    async jumpShip(shipSymbol: any, jumpShipRequest?: JumpShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JumpShip200Response> {
     ...
     * Navigate Ship
     */
    async navigateShip(shipSymbol: any, navigateShipRequest?: NavigateShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NavigateShip200Response> {
     ...
     * Negotiate Contract
     */
    async negotiateContract(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<NegotiateContract200Response> {
     ...
     * Orbit Ship
     */
    async orbitShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<OrbitShip200Response> {
     ...
     * Patch Ship Nav
     */
    async patchShipNav(shipSymbol: any, patchShipNavRequest?: PatchShipNavRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<GetShipNav200Response> {
     ...
     * Purchase Cargo
     */
    async purchaseCargo(shipSymbol: any, purchaseCargoRequest?: PurchaseCargoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PurchaseCargo201Response> {
     ...
     * Refuel Ship
     */
    async refuelShip(shipSymbol: any, refuelShipRequest?: RefuelShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RefuelShip200Response> {
     ...
     * Remove Mount
     */
    async removeMount(shipSymbol: any, removeMountRequest?: RemoveMountRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RemoveMount201Response> {
    ...
    async repairShipRaw(requestParameters: RepairShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<RepairShip200Response>> {
        if (requestParameters.shipSymbol === null || requestParameters.shipSymbol === undefined) {
            throw new runtime.RequiredError('shipSymbol','Required parameter requestParameters.shipSymbol was null or undefined when calling repairShip.');
        }
     ...
     * Repair Ship
     */
    async repairShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<RepairShip200Response> {
        const response = await this.repairShipRaw({ shipSymbol: shipSymbol }, initOverrides);
        return await response.value();
    }
    ...
    async scrapShipRaw(requestParameters: ScrapShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ScrapShip200Response>> {
        if (requestParameters.shipSymbol === null || requestParameters.shipSymbol === undefined) {
            throw new runtime.RequiredError('shipSymbol','Required parameter requestParameters.shipSymbol was null or undefined when calling scrapShip.');
        }
     ...
     * Scrap Ship
     */
    async scrapShip(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ScrapShip200Response> {
        const response = await this.scrapShipRaw({ shipSymbol: shipSymbol }, initOverrides);
        return await response.value();
    }
     ...
     * Sell Cargo
     */
    async sellCargo(shipSymbol: any, sellCargoRequest?: SellCargoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SellCargo201Response> {
     ...
     * Ship Refine
     */
    async shipRefine(shipSymbol: any, shipRefineRequest?: ShipRefineRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ShipRefine201Response> {
     ...
     * Siphon Resources
     */
    async siphonResources(shipSymbol: any, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<SiphonResources201Response> {
     ...
     * Transfer Cargo
     */
    async transferCargo(shipSymbol: any, transferCargoRequest?: TransferCargoRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<TransferCargo200Response> {
     ...
     * Warp Ship
     */
    async warpShip(shipSymbol: any, navigateShipRequest?: NavigateShipRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<WarpShip200Response> {
