...
export const FleetApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * Get the cost of repairing a ship.
         * @summary Get Repair Ship
         * @param {FleetApiGetRepairShipRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getRepairShip(requestParameters: FleetApiGetRepairShipRequest, options?: AxiosRequestConfig): AxiosPromise<GetRepairShip200Response> {
            return localVarFp.getRepairShip(requestParameters.shipSymbol, options).then((request) => request(axios, basePath));
        },
        /**
         * Get the amount of value that will be returned when scrapping a ship.
         * @summary Get Scrap Ship
         * @param {FleetApiGetScrapShipRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        getScrapShip(requestParameters: FleetApiGetScrapShipRequest, options?: AxiosRequestConfig): AxiosPromise<GetScrapShip200Response> {
            return localVarFp.getScrapShip(requestParameters.shipSymbol, options).then((request) => request(axios, basePath));
        },
        /**
         * Retrieve the details of your ship\'s reactor cooldown. Some actions such as activating your jump drive, scanning, or extracting resources taxes your reactor and results in a cooldown.  Your ship cannot perform additional actions until your cooldown has expired. The duration of your cooldown is relative to the power consumption of the related modules or mounts for the action taken.  Response returns a 204 status code (no-content) when the ship has no cooldown.
         * @summary Get Ship Cooldown
         ...
         * Repair a ship, restoring the ship to maximum condition. The ship must be docked at a waypoint that has the `Shipyard` trait in order to use this function. To preview the cost of repairing the ship, use the Get action.
         * @summary Repair Ship
         * @param {FleetApiRepairShipRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        repairShip(requestParameters: FleetApiRepairShipRequest, options?: AxiosRequestConfig): AxiosPromise<RepairShip200Response> {
            return localVarFp.repairShip(requestParameters.shipSymbol, options).then((request) => request(axios, basePath));
        },
        /**
         * Scrap a ship, removing it from the game and returning a portion of the ship\'s value to the agent. The ship must be docked in a waypoint that has the `Shipyard` trait in order to use this function. To preview the amount of value that will be returned, use the Get Ship action.
         * @summary Scrap Ship
         * @param {FleetApiScrapShipRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        scrapShip(requestParameters: FleetApiScrapShipRequest, options?: AxiosRequestConfig): AxiosPromise<ScrapShip200Response> {
            return localVarFp.scrapShip(requestParameters.shipSymbol, options).then((request) => request(axios, basePath));
        },
        /**
         * Sell cargo in your ship to a market that trades this cargo. The ship must be docked in a waypoint that has the `Marketplace` trait in order to use this function.
         * @summary Sell Cargo
         ...
         * Siphon gases, such as hydrocarbon, from gas giants.  The ship must be in orbit to be able to siphon and must have siphon mounts and a gas processor installed.
         * @summary Siphon Resources
         * @param {FleetApiSiphonResourcesRequest} requestParameters Request parameters.
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        siphonResources(requestParameters: FleetApiSiphonResourcesRequest, options?: AxiosRequestConfig): AxiosPromise<SiphonResources201Response> {
            return localVarFp.siphonResources(requestParameters.shipSymbol, options).then((request) => request(axios, basePath));
        },
        /**
         * Transfer cargo between ships.  The receiving ship must be in the same waypoint as the transferring ship, and it must able to hold the additional cargo after the transfer is complete. Both ships also must be in the same state, either both are docked or both are orbiting.  The response body\'s cargo shows the cargo of the transferring ship after the transfer is complete.
         * @summary Transfer Cargo
         ...
         * @throws {RequiredError}
         */
        warpShip(requestParameters: FleetApiWarpShipRequest, options?: AxiosRequestConfig): AxiosPromise<WarpShip200Response> {
...
/**
 * Request parameters for getRepairShip operation in FleetApi.
 * @export
 * @interface FleetApiGetRepairShipRequest
 */
...
/**
 * Request parameters for getScrapShip operation in FleetApi.
 * @export
 * @interface FleetApiGetScrapShipRequest
 */
...
/**
 * Request parameters for repairShip operation in FleetApi.
 * @export
 * @interface FleetApiRepairShipRequest
 */
...
/**
 * Request parameters for scrapShip operation in FleetApi.
 * @export
 * @interface FleetApiScrapShipRequest
 */
...
/**
 * Request parameters for siphonResources operation in FleetApi.
 * @export
 * @interface FleetApiSiphonResourcesRequest
 */
...
export class FleetApi extends BaseAPI {
     ...
     * @memberof FleetApi
     */
    public getRepairShip(requestParameters: FleetApiGetRepairShipRequest, options?: AxiosRequestConfig) {
        return FleetApiFp(this.configuration).getRepairShip(requestParameters.shipSymbol, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FleetApi
     */
    public getScrapShip(requestParameters: FleetApiGetScrapShipRequest, options?: AxiosRequestConfig) {
        return FleetApiFp(this.configuration).getScrapShip(requestParameters.shipSymbol, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FleetApi
     */
    public repairShip(requestParameters: FleetApiRepairShipRequest, options?: AxiosRequestConfig) {
        return FleetApiFp(this.configuration).repairShip(requestParameters.shipSymbol, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FleetApi
     */
    public scrapShip(requestParameters: FleetApiScrapShipRequest, options?: AxiosRequestConfig) {
        return FleetApiFp(this.configuration).scrapShip(requestParameters.shipSymbol, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof FleetApi
     */
    public siphonResources(requestParameters: FleetApiSiphonResourcesRequest, options?: AxiosRequestConfig) {
        return FleetApiFp(this.configuration).siphonResources(requestParameters.shipSymbol, options).then((request) => request(this.axios, this.basePath));
    }
