...
/**
 * Check if a given object implements the ExtractResourcesRequestSurvey interface.
 */
export function instanceOfExtractResourcesRequestSurvey(value: object): boolean {
    let isInstance = true;
...
export function ExtractResourcesRequestSurveyFromJSON(json: any): ExtractResourcesRequestSurvey {
    return ExtractResourcesRequestSurveyFromJSONTyped(json, false);
}

export function ExtractResourcesRequestSurveyFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtractResourcesRequestSurvey {
...
export function ExtractResourcesRequestSurveyToJSON(value?: ExtractResourcesRequestSurvey | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
