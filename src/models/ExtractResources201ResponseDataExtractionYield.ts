 ...
 * @export
 * @interface ExtractResources201ResponseDataExtractionYield
 */
export interface ExtractResources201ResponseDataExtractionYield {
    /**
     * The good's symbol.
     * @type {any}
     * @memberof ExtractResources201ResponseDataExtractionYield
     */
    symbol: ExtractResources201ResponseDataExtractionYieldSymbolEnum;
    /**
 ...
 * @export
 */
export const ExtractResources201ResponseDataExtractionYieldSymbolEnum = {
...
export type ExtractResources201ResponseDataExtractionYieldSymbolEnum = typeof ExtractResources201ResponseDataExtractionYieldSymbolEnum[keyof typeof ExtractResources201ResponseDataExtractionYieldSymbolEnum];


/**
 * Check if a given object implements the ExtractResources201ResponseDataExtractionYield interface.
 */
export function instanceOfExtractResources201ResponseDataExtractionYield(value: object): boolean {
    let isInstance = true;
...
export function ExtractResources201ResponseDataExtractionYieldFromJSON(json: any): ExtractResources201ResponseDataExtractionYield {
    return ExtractResources201ResponseDataExtractionYieldFromJSONTyped(json, false);
}

export function ExtractResources201ResponseDataExtractionYieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): ExtractResources201ResponseDataExtractionYield {
...
export function ExtractResources201ResponseDataExtractionYieldToJSON(value?: ExtractResources201ResponseDataExtractionYield | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
