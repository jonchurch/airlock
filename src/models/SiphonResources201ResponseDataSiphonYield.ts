 ...
 * @export
 * @interface SiphonResources201ResponseDataSiphonYield
 */
export interface SiphonResources201ResponseDataSiphonYield {
    /**
     * The good's symbol.
     * @type {any}
     * @memberof SiphonResources201ResponseDataSiphonYield
     */
    symbol: SiphonResources201ResponseDataSiphonYieldSymbolEnum;
    /**
 ...
 * @export
 */
export const SiphonResources201ResponseDataSiphonYieldSymbolEnum = {
...
export type SiphonResources201ResponseDataSiphonYieldSymbolEnum = typeof SiphonResources201ResponseDataSiphonYieldSymbolEnum[keyof typeof SiphonResources201ResponseDataSiphonYieldSymbolEnum];


/**
 * Check if a given object implements the SiphonResources201ResponseDataSiphonYield interface.
 */
export function instanceOfSiphonResources201ResponseDataSiphonYield(value: object): boolean {
    let isInstance = true;
...
export function SiphonResources201ResponseDataSiphonYieldFromJSON(json: any): SiphonResources201ResponseDataSiphonYield {
    return SiphonResources201ResponseDataSiphonYieldFromJSONTyped(json, false);
}

export function SiphonResources201ResponseDataSiphonYieldFromJSONTyped(json: any, ignoreDiscriminator: boolean): SiphonResources201ResponseDataSiphonYield {
...
export function SiphonResources201ResponseDataSiphonYieldToJSON(value?: SiphonResources201ResponseDataSiphonYield | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
